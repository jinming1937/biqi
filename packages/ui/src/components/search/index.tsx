...
export class Search extends Component<SearchProps, SearchState> {
  ...
  render() {
    ...
    return <input maxLength={30} placeholder={placeholder} ref={this.ref} className={classnames(getPrefixCls('searchBox'), {[getPrefixCls('redBox')]: !isValid})} value={value} onChange={this.onSeachChange} onKeyDown={this.onEnter} />
  }
}
